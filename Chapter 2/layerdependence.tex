...
\begin{figure}
  \begin{center}
    ...
    \end{tabular}
    \caption{The left panel shows the weight functions $w_\alpha=6\alpha(1-\alpha)$ (black), $w_\alpha=1$ (blue), $w_\alpha=3\alpha^2$ (green), $w_\alpha=3(1-\alpha)^2$ (yellow). The right panel shows a Clayton copula with a red layer dependence curve and overall dependence measures $\rho$, $\rho_1$, $\rho_2$ and $\rho_3$ indicated using the same colors as corresponding weight functions in the left panel.  }
    \label{falternate}
  \end{center}
\end{figure}
